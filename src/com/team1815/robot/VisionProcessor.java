...
public class VisionProcessor {
     ...
     * Off the robot
     */
    RGBImage positveImage, negativeImage;
    ...
    /**
     * Constructor for the vision processor if we're running on the robot.
    ...
    /**
     * Constructor for the vision processor if we're not running on the robot
     * @param positiveImage The image with a reflector.
     * @param negativeImage The image without a reflector.
     */
    public VisionProcessor(RGBImage positiveImage, RGBImage negativeImage) {
        this.positveImage = positiveImage;
